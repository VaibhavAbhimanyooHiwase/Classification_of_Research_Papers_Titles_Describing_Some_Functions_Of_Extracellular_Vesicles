...
keyword_file = open("Keyword_file_imp_paper_3.txt", "w")
...
no_keywords_file = open("No_Keywords_imp_paper_3.txt", "w")
no_keywords_file.write(str(no_keywords))

csv_file = open("Dataframe_PMID_Keywords_imp_paper_3.csv", "w") 
PMID_Keywords_Dataframe.to_csv(csv_file)
csv_file.close()

d = pd.read_csv('Dataframe_PMID_Keywords_imp_paper_3.csv')
...
txt_keyword_corpus = open("keyword_corpus_imp_paper_3.txt", "w") 
txt_keyword_corpus.write(str(keyword_corpus))
txt_keyword_corpus.close()

keys = open("keyword_corpus_imp_paper_3.txt", "r")
